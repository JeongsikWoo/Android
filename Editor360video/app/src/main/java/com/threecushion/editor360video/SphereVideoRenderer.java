...
public class SphereVideoRenderer implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        GLES20.glVertexAttribPointer(mTextureCoordinateHandle, mTextureCoordinateDataSize, GLES20.GL_FLOAT, false, 0, mSphereTextureCoordinates);
    ...
    private void drawRectangle() {
        ...
        GLES20.glVertexAttribPointer(mPositionHandle, COORDS_PER_VERTEX, GLES20.GL_FLOAT, false, vertexStride, mRectangleVertexBuffer);
